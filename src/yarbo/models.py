...
STRUCTURED_MQTT_KEYS: frozenset[str] = frozenset(
    {
        ...
        "BatteryMSG.status",
        "BatteryMSG.temp_err",
        "BatteryMSG.timestamp",
        "BatteryMSG.wireless_charge_voltage",
        ...
        "StateMSG.chute_angle",
        "StateMSG.route_priority",
        "StateMSG.adjustangle_status",
        "StateMSG.auto_draw_waiting_state",
        "StateMSG.en_state_led",
        "StateMSG.en_warn_led",
        "StateMSG.on_going_to_start_point",
        "StateMSG.on_mul_points",
        "StateMSG.robot_follow_state",
        "StateMSG.schedule_cancel",
        "StateMSG.vision_auto_draw_state",
        "RTKMSG.heading",
        "RTKMSG.status",
        "RTKMSG.timestamp",
        "RTKMSG.gga_atn_dis",
        "RTKMSG.heading_atn_dis",
        "RTKMSG.heading_dop",
        "RTKMSG.heading_status",
        "RTKMSG.pre4_timestamp",
        "RTKMSG.rtk_version",
        "CombinedOdom.x",
        "CombinedOdom.y",
        "CombinedOdom.phi",
        "CombinedOdom.confidence",
        "combined_odom_confidence",
        "HeadMsg.head_type",
        "HeadMsg.name",
        "HeadMsg.sn",
        "HeadMsg.serial_number",
...
class YarboTelemetry:
    ...
    def from_dict(cls, d: dict[str, Any], topic: str | None = None) -> YarboTelemetry:  # noqa: PLR0915
        ...
        return cls(
            ...
            battery_temp_err=(
                battery_msg.get("temp_err") if battery_msg else d.get("battery_temp_err")
            ),
            ...
            auto_draw_waiting_state=state_msg.get("auto_draw_waiting_state") if state_msg else None,
            ...
            on_going_to_start_point=state_msg.get("on_going_to_start_point") if state_msg else None,
            ...
            vision_auto_draw_state=state_msg.get("vision_auto_draw_state") if state_msg else None,
